...
class GaussianDiffusion:
    ...
    def __init__(
        ...
        *,
        ...
        # # If using the "optim" schedule, adjust the last 61 values of alphas_cumprod
        # if "optim" in self.mse_loss_weight_type.lower():
        #     end_adjustment_start = self.num_timesteps - 61
        #     self.alphas_cumprod[end_adjustment_start:] = np.linspace(
        #         self.alphas_cumprod[end_adjustment_start], 1e-8, 61
        #     )
